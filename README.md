...
If you are interested specifically in the detailed documentation and code to replicate the tables and files in the above cited paper, please refer to https://pubsonline.informs.org/doi/suppl/10.1287/mksc.2021.1346.
